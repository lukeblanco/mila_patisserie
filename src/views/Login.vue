                ...
                <div class="mt-4">
                    <label class="block">Password</label>
                        ...
                        class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600">
                                ...
                                <p v-if="error" class="text-red-800 font-bold pt-4">Has introducido mal el email o la contraseña.</p>

              <div class="flex items-baseline justify-between">
                  
                    <button type="button" v-on:click="login()" class="px-6 py-2 mt-4 text-white bg-blue-600 rounded-lg hover:bg-blue-900">Login</button>
                </div>
            </div>
        </form>
    </div>
...
import axios from 'axios';
    ...
    methods:{
        ...
        axios.get(URL_USER, {params: json}
        )
        .then( response => {
